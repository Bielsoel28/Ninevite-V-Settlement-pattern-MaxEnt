...
if(file.exists(jar)){
  FR.maxent_1<-maxent(x=maxent_train,p=as.factor(me_pa),path=".MaxEnt models/MaxEnt_Final/1")
}
...
jar <- paste(system.file(package="dismo"), "/java/maxent.jar", sep='')
if(file.exists(jar)){
  FR.maxent_2<-maxent(x=maxent_train,p=as.factor(me_pa),path=".MaxEnt models/FR.MaxEnt_Final/2")
}
...
jar <- paste(system.file(package="dismo"), "/java/maxent.jar", sep='')
if(file.exists(jar)){
  FR.maxent_3<-maxent(x=maxent_train,p=as.factor(me_pa),path=".MaxEnt models/FR.MaxEnt_Final/3")
}
...
jar <- paste(system.file(package="dismo"), "/java/maxent.jar", sep='')
if(file.exists(jar)){
  FR.maxent_4<-maxent(x=maxent_train,p=me_pa,path=".MaxEnt models/FR.MaxEnt_Final/4")
}
